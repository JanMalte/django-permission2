...
from tests.utils import create_anonymous, create_article, create_group, create_user
...
class PermissionLogicsAuthorPermissionLogicTestCase(TestCase):
    ...
    def test_has_perm_add_with_obj(self):
        ...
        self.assertFalse(permission_logic.has_perm(self.user3, self.perm1, self.article))
